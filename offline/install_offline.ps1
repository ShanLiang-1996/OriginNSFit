...
Write-Host "Installing OriginNSFit package"
...
Write-Host ".\.venv\Scripts\python.exe -m originnsfit --input examples --output output --pattern e739_example.csv --level `"名义水平`" --dry-run"
